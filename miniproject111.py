    ...
    if ch == "A":
        ...
        while True:
            ...
            if uc == 'a':
                ...
                print("\n" + "=" * 50)
                print("TRIVENI VEGETABLES INVOICE")
                print("Shop No. 1 , Defence Colony, Ameenpur")
                print("Hyderabad, Telangana, India")
                print("Phone: 7989020039")
                print("Email: naredlatriveni@gmail.com")
                print("=" * 50)
